...
- **[Douglas G. Bonett](https://people.ucsc.edu/~dgbonett/)**. Author,
  maintainer.

- **Robert J. Calin-Jageman**. Contributor.
...
package version 1.8.0, https://dgbonett.github.io/statpsych/,
<https://github.com/dgbonett/statpsych/>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 1.8.0, https://dgbonett.github.io/statpsych/},
