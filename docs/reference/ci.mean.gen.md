...
(square-root, geometric, and harmonic) using a vector of response scores
as input. The square-root mean requires non-negative scores. The
geometric and harmonic means require positive scores. The standard
errors are recovered from the confidence intervals.
