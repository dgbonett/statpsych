...
computation. The probability that the 1 - alpha1 confidence interval in
the planned study will have a width that is less than the desired width
is approximately 1 - alpha2 where alpha1 and alpha2 are specified
values.
