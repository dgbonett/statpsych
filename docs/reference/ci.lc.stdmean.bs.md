...
and nonexperimental designs. Equality of variances is not assumed. If
the group 1 standardizer is used, group 1 would typically be a control
group or a comparison group.
