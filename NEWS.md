...
* New functions:
    ...
    * ci.var -- Computes two-sided or one-sided confidence limits for a single-group variance, a pooled variance, or a residual variance (this function will soon replace the ci.var.upper function)
